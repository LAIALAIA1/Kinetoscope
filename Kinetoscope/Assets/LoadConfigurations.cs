...
public class LoadConfigurations : MonoBehaviour {
	...
	void Start () {
		...
		if (float.TryParse (iniConfigs.IniReadValue (CALIBRATION_SECTION, INIValues.ObservatorX.Value), out observatorX)
		    && float.TryParse (iniConfigs.IniReadValue (CALIBRATION_SECTION, INIValues.ObservatorY.Value), out observatorY)
		    && float.TryParse (iniConfigs.IniReadValue (CALIBRATION_SECTION, INIValues.ObservatorZ.Value), out observatorZ)) {
